...
rm -rf ../../../../target/clustered-static-node0/data
...
../../../../target/clustered-static-node0/bin/artemis stop
../../../../target/clustered-static-node1/bin/artemis stop
../../../../target/clustered-static-node2/bin/artemis stop
